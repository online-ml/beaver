...
class Project(Base, table=True):  # type: ignore[call-arg]
    ...
    # Relationships
    message_bus: "MessageBus" = sqlmodel.Relationship(  # noqa: F821
        back_populates="projects"
    )
    stream_processor: "StreamProcessor" = sqlmodel.Relationship(  # noqa: F821
        back_populates="projects"
    )
    job_runner: "JobRunner" = sqlmodel.Relationship(  # noqa: F821
        back_populates="projects"
    )
    target: Optional["Target"] = sqlmodel.Relationship(  # noqa: F821
        back_populates="project", sa_relationship_kwargs={"uselist": False}
    )
    feature_sets: list["FeatureSet"] = sqlmodel.Relationship(  # noqa: F821
